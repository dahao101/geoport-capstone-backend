...
def delete_template(name, details):
    html_content = f"""
        <!DOCTYPE html>
        <html lang="en">
        <head>
            ...
            <title>False Reporting Notice</title>
        ...
        <body>
            <div class="email-container">
                <div class="header">
                    ...
                    <h2>False Reporting Notice</h2>
                </div>
                <div class="content">
                    <p>Dear {name},</p>
                    <p>Your report about <strong>{details}</strong> has been flagged as inaccurate. The reported location does not match any highways in the area.</p>
                    <p>Please review and update the details. Accurate reports help maintain system integrity. Uncorrected reports may lead to disciplinary actions.</p>
