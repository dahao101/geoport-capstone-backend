...
def pin_sender_template( name, pin):
    html_content = f"""
        <!DOCTYPE html>
        <html lang="en">
        <head>
        ...
        <body>
            <div class="email-container">
                ...
                <div class="content">
                    <p>Dear {name},</p>
                    <p>We received a request to verify your identity. To complete the process, please use the following PIN code:</p><br/><br/>
                    <h3>{pin}</h3><br/><br/>
                    <p>For your security, this PIN code will expire in 3 minutes. If you didn’t request this verification, you can ignore this email. </p><br />
