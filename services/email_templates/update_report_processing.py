...
def update_report_processing(email, name, details):
    html_content = f"""
        <!DOCTYPE html>
        <html lang="en">
        <head>
        ...
        <body>
            <div class="email-container">
                <div class="header">
                    ...
                    <h2>Verified Report Notification</h2>
                </div>
                <div class="content">
                    <p>Dear {name},</p>
                    <p>Your report about <strong>{details}</strong> has been identified as VALID. We have already deployed maintenance crew on the said location.</p>
