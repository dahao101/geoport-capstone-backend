...
def update_report_solved(email, name, details):
    html_content = f"""
        <!DOCTYPE html>
        <html lang="en">
        <head>
        ...
        <body>
            <div class="email-container">
                <div class="header">
                    ...
                    <h2>Solved Report Notification</h2>
                </div>
                <div class="content">
                    <p>Dear {name},</p>
                    <p>Your report about <strong>{details}</strong> has been marked as SOLVED/FINISH. We, CDRRMO deeply appreciate your willingness on keeping Malaybalay City more productive and sustainable.</p>
